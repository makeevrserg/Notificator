...
import com.makeevrserg.notificator.service.MyWorker
...
class MyFirebaseMessagingService : FirebaseMessagingService() {
    ...
    override fun onMessageReceived(remoteMessage: RemoteMessage) {
        ...
        Log.d(TAG, "onMessageReceived: ${remoteMessage.notification?.clickAction}")
...
//        )
        ...
        val notificationBuilder = NotificationCompat.Builder(this, channelId)
            ...
            .setContentTitle(data["title"]?:notification?.title ?: getString(R.string.fcm_message))
        ...
        val futureTarget = Glide.with(this)
            .asBitmap()
            .load(data["large_icon"]?:"https://empireprojekt.ru/static/media/server-icon.d692cf75.png")
            .submit()
